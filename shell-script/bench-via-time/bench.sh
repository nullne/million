...
repeats=20
output_file='/tmp/bench-results.csv'
...
run_tests() {
    ...
    do
        ...
        #  chrt runs your benchmark in FIFO real-time class with priority 99, which makes your process the top priority process and avoids context switching
